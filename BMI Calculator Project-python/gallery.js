const galleries = [
    {
        id: 'gallery1',
        images: [
            'BMI Calc Project photos/BMI formula.png'
        ],
        footnotes: [
            'BMI Formula'
        ]
    },
    {
        id: 'gallery2',
        images: [
            'BMI Calc Project photos/Weight category.png'
        ],
        footnotes: [
            'Thresholds'
        ]
    },
    {
        id: 'gallery3',
        images: [
            'BMI Calc Project photos/BMI calc code.png'
        ],
        footnotes: [
    ...
    },
    {
        id: 'gallery4',
        images: [
            'BMI Calc Project photos/name input.png',
            'BMI Calc Project photos/Height input.png',
            'BMI Calc Project photos/Final Output.png'
        ],
        footnotes: [
            'Prompts the name of the user',
            'Asks the user to input their names',
            'Final output'
        ]
    }
];
